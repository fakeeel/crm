...
public class ActivityServiceImpl implements ActivityService{
	...
	@Override
	public void saveOrUpdateActivity(CstActivity atv) {
		if(atv.getAtvId()==null) {
			activityMapper.insertSelective(atv);
		}else {
			activityMapper.updateByPrimaryKey(atv);
		}
	}

	@Override
	public CstActivity findActivityById(long atvId) {
		CstActivity atv = activityMapper.selectByPrimaryKey(atvId);
		return atv;
	}
