...
<div class="fenye">
		<table class="footTable">
			<tr>
				<td colspan="5">共${userinfo.total } 条记录 每页${userinfo.size }
					条 第${userinfo.pageNum } 页 <a href="javascript:void(0)"
...
<script type="text/javascript">
	function pageSelect(curPage){
		var url = "user/findAllUser/"+curPage;
		$('.layui-body').load(url)
	}
	$(function(){
		var usrId;
		...
		$('.search').click(function(){
			var type = $("select[name=usrRoleName] option:selected").val();
			var url = "user/findUserEqualTo/1";
			$('.layui-body').load(url,{type:type});
		})
	})
</script>