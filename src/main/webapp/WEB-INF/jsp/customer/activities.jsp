...
<div class="fenye">
		<table class="footTable">
			<tr>
				<td colspan="5">共${activityinfo.total } 条记录 每页${activityinfo.size }
					条 第${activityinfo.pageNum } 页 <a href="javascript:void(0)"
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.btn-primary').click(function(){
			var url = "activity/deleteActivityById/"+activityId;
			$(".layui-body").load(url);
		...
		$('button:contains(保存)').on('click',function(){
			...
			var url ="activity/saveOrUpdateActivity";
		...
		$('.editUser').click(function(){
			activityId = $(this).attr("value");
			var url = "activity/findActivityById/"+activityId;
